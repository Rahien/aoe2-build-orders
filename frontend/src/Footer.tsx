...
export default function(){
  return <>
    <BMC/>
    <div className="wrap-960 game-content-useage-notice">Special thanks to everyone who make build orders publicly available! <span role="img" aria-label="heart">❤️</span> The source for this app is available on <a href="https://github.com/Rahien/aoe2-build-orders" target="_blank" rel="noopener noreferrer">github</a></div>
